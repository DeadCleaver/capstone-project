    ...
    <Dropdown>
      ...
      <Dropdown.Menu align="end">
        {userToken &&  
                ...
                <Dropdown.Item as={Link} to="/session">Crea Sessione</Dropdown.Item>
                <Dropdown.Item as={Link} to="/sessions">Sessioni</Dropdown.Item>
                <Dropdown.Item as={Link} to="/games">Giochi</Dropdown.Item>
                <hr />
                </div>
        }
